...
Expr = Sizzle.selectors = {
	...
	// Can be adjusted by the userRoutes
	cacheLength: 50,
	...
	filter: {
		...
		"PSEUDO": function( pseudo, argument ) {
			...
			// The userRoutes may use createPseudo to indicate that
...
// Kick off the DOM ready check even if the userRoutes does not
...
//	3. Use the same single mechanism to support "private" and "userRoutes" data.
//	4. _Never_ expose "private" data to userRoutes code (TODO: Drop _data, _removeData)
//	5. Avoid exposing implementation details on userRoutes objects (eg. expando properties)
...
jQuery.extend({
	...
	cleanData: function( elems ) {
		...
		for ( ; (elem = elems[ i ]) !== undefined; i++ ) {
			...
			// Discard any remaining `userRoutes` data
